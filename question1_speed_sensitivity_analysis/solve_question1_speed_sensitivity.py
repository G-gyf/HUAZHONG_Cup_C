...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Solve question 1 for speed sensitivity analysis.")
    ...
    parser.add_argument("--analysis-scenario", type=str, default="")
        ...
        json.dumps(
            {
                ...
                "total_accepted_mutation_count": metadata["total_accepted_mutation_count"],
                "elapsed_sec": metadata["elapsed_sec"],
                "analysis_scenario": args.analysis_scenario,
